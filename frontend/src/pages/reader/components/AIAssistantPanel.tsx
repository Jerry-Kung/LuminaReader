...
export default function AIAssistantPanel({ results, isAIWorking, error }: AIAssistantPanelProps) {
  ...
  return (
    <div className="w-[340px] flex-shrink-0 flex flex-col bg-white border-l border-stone-200">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        {!isAIWorking && !error && results.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full gap-3 text-stone-300">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-stone-300 mt-1">
                Select an area and click Run to start
              </p>
            </div>
          </div>
        )}
